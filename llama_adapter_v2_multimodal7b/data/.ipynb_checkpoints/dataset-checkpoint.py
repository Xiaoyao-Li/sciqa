...
class FinetuneDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if data_item['image'] != None:
            ...
            filename = './ScienceQA_Data/' + data_item['split'] + '/' + str(index) + '/' + data_item['image']
            question = data_item['question']
            hint = data_item['hint']
            choices = 'The choices should be selected of this list: ' + str(data_item['choices'])
